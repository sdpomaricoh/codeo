...
var Menu = __webpack_require__(123);
var Hero = __webpack_require__(124);
var Dates = __webpack_require__(125);
var Post = __webpack_require__(128);
...
var menuFullWidth = function menuFullWidth() {
	var Menu = {
		settings: {
		...
		scroll: function scroll(_scroll) {
			var hero = $('#hero').length,
			    postHeader = $('.postHeader').length,
			    authorHeader = $('.authorHeader').length;
			if (hero !== 0) {
				var e = this.settings,
				    height = $('#hero').height() - e.navigation.height();
				if (_scroll >= height) {
				...
				var _e = this.settings,
				    _height = $('.postHeader').height() - $('header').height();
				if (_scroll >= _height) {
					_e.navigation.addClass('header-is-scroll');
					$('.logo-img > svg.is-post').addClass('is-logo-scroll');
					$('.menuIcon-toggle.is-post').addClass('is-toggle-scroll');
				} else {
					_e.navigation.removeClass('header-is-scroll');
				...
				var _e2 = this.settings,
				    _height2 = $('.authorHeader').height() - _e2.navigation.height();
				if (_scroll >= _height2) {
					_e2.navigation.addClass('header-is-scroll');
				} else {
					_e2.navigation.removeClass('header-is-scroll');
				}
			}
		}
	};
	...
	var Hero = {
		...
		Scroll: function Scroll() {
			...
			if (hero.length !== 0) {
				...
				$(window).scroll(function () {
					var headerHeight = postHeader.height(),
					    top = $(document).scrollTop();
...
var Dates = function Dates() {
	moment.locale('es');
	$('.date time').each(function (i, date) {
		var $date = $(date);
		$date.html(moment($date.attr('datetime')).format('MMMM DD, YYYY'));
	});
};
...
var Post = function Post() {
	var post = {
		metadataIcon: function metadataIcon() {
			$(document).ready(function () {
		...
		twitter: function twitter() {
			$(document).ready(function () {
				...
				var title = $('#twitterShare').data('title');
				var text = encodeURI(title);
				var href = $('#twitterShare').data('href');
				var url = intent + 'text=' + text + '&url=' + href + '&via=codeoweb';
		...
		linkedin: function linkedin() {
			$(document).ready(function () {
				var intent = 'https://www.linkedin.com/shareArticle?mini=true&url=';
				var title = $('#linkedinShare').data('title');
				var text = encodeURI(title);
				var href = $('#linkedinShare').data('href');
				var url = intent + href + '&title=' + text + '&source=Codeo';
		...
		whatsapp: function whatsapp() {
			$(document).ready(function () {
				var whatsapp = $('#whatsappShare');
				var intent = 'whatsapp://send?text=';
				var title = whatsapp.data('title');
				var text = encodeURI(title);
				var href = whatsapp.data('href');
				var url = intent + text + ' - ' + href;
		...
		progress: function progress() {
			$(document).ready(function () {
				...
				$(document).on('scroll', function () {
					var isScroll = $('header').hasClass('header-is-scroll');
					if (isScroll) progressBar.css('opacity', 1);else progressBar.css('opacity', 0);
					setWidth();
				});
